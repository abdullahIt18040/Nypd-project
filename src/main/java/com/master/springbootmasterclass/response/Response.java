package com.master.springbootmasterclass.response;
...
public class Response {
    ...
    public static ResponseEntity<Response> getResponseData(HttpStatus httpStatus, String message, Object payload) {
